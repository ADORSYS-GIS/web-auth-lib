                        ...
                        <div className='flex flex-col justify-center gap-4'>
                            <div className='flex flex-col gap-2'>
                                ...
                                <p className='opacity-75'>
                                    ...
                                    credential from the browser. The user cannot login easily
                                </p>
                            </div>
                            ...
                            <div className='grid md:grid-cols-2 gap-4'>
                                <div className='flex flex-col gap-2'>
                                    <Authenticate/>
                                    <p className='opacity-75'>
                                        This will try using the credential previously saved. If no credential, it will
                                        not
                                        work.
                                    </p>
                                </div>
                                ...
                                <div className='flex flex-col gap-2'>
                                    <Logout/>
                                    <p className='opacity-75'>
                                        This will remove the userID from the memory. This will not remove the
                                        credential from the browser. The user can still login easily
                                    </p>
                                </div>
                            </div>
